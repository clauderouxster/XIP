...
int ntmUTF8StringSetInputObject( void *pInputObject, unsigned char* pString) {
    ...
    memset((void *)(((ntmUTF8StringInputObject*)pInputObject)->utf8_buf), 0, length * sizeof(UTF8));
    memset((void *)(((ntmUTF8StringInputObject*)pInputObject)->utf16_buf), 0, length * sizeof(UTF16));
    return 0;
}
