/* $Id: ntmextern.h,v 1.2 2007/02/16 16:51:52 ait Exp $ */ 
...
extern int checkLeftContext( NtmContext *ct, Levels* lev, long leftpos,
                             long rightpos,
                             STATEptr fromstate,
                             NETptr net);
extern int checkRightContext( NtmContext *ct, Levels *lev, long rightpos,
                              STATEptr fromstate,
                       NETptr net);
...
/*  */
extern id_type readInputCharId(NtmContext* ct, Levels* levels, long pos);
extern int endOfInput(NtmContext* ct, Levels* levels, long pos);
