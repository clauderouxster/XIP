...
public class Test {
	...
	public void parse(String inputFileName) throws Exception {
		...
		xipResultManager.xipResultBuilderFromTextFile(gHandler, inputFileName, this, "myCB1");
	}
	...
	public final static void main(String args[]) {
		if (args.length != 2) {
			System.out.println("Two parameters are required: the path of the grm file, and the text file to parse");
			System.exit(-1);
		}
		try {
