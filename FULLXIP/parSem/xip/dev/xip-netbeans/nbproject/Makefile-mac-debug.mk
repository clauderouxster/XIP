...
LDLIBSOPTIONS=-L../../../fst/dev/lib/mac-i386.debug/staticLib -L../../../xml/dev/lib/mac-i386.debug/staticLib -L../../../ntm/dev/lib/mac-i386.debug/staticLib -lxml -lntm -lfst -lz -lm -lpthread -mt -lstdc++ -lm -lpthread -lz -ldl -lgcc_s.10.4

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-mac-debug.mk xipMac-debug

xipMac-debug: ${OBJECTFILES}
	${LINK.cc} -o xipMac-debug ${OBJECTFILES} ${LDLIBSOPTIONS} 
