...
typedef enum {ARCINITIAL,ARCSIMPLE,ARCCOMPLEXE,ARCBOUCLE,ARCCROCHET,ARCVIRGULE,ARCFINCROPAR,ARCPARENTHESE} typeautoparse;
...
typedef enum {AUTOMATONIF,AUTOMATONELSE,AUTOMATONEPSILON,AUTOMATONANY,AUTOMATONDIGIT,AUTOMATONPUNCT,
	AUTOMATONLETTER,AUTOMATONLETTERUPPER,AUTOMATONLABEL,AUTOMATONVARIABLE,AUTOMATONSTAR='*',AUTOMATONPLUS='+'} arcautomate;
...
typedef enum { AERR_NO_ERROR,AERR_MISSING_PARENTHESIS,AERR_MISSING_BRACKET,AERR_WRONG_NEGATION_POSITION,AERR_WRONG_USE_OF_COMMA,
	AERR_WRONG_KLEENE,AERR_MISMATCHED_PARENTHESIS,AERR_MISMATCHED_BRACKET,AERR_WRONG_VARIABLE_ORDER} autoerreur;
