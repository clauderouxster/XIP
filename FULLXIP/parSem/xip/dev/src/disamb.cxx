...
/* $Id: disamb.cxx,v 1.45 2016/06/06 08:15:21 roux Exp $ */
...
void GlobalParseurHMM::error_message (const char *msg, ...)
{
    ...
    sprintf_s(MessageErreur,1000, "ERROR in '%s'%s", PROGRAM_NAME_HMM, section);
    
    if (DISAMB_FLAGS.system.cur_line_num > 0)
        sprintf_s(MessageErreur,1000, ", line %li", DISAMB_FLAGS.system.cur_line_num);
    
    sprintf_s(MessageErreur,1000, " :\n");
    
    va_start (ap, msg);
    vsprintf_s(MessageErreur,1000, msg, ap);  
    NOM="HMM MODULE";
