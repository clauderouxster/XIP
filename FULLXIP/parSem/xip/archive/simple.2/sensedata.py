...
senses["drinkedeiag"] = [{"wordata":"retan#2 drinkedeiag#1", "francais":["verb(#1),prep(de),noun(#2)"]}]
senses["drinkeiag"] = [{"wordata":"retan#2 drinkeiag#1", "francais":["verb(#1),prep(avec),prep(de),noun(#2)"]}]
