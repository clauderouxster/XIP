...
class generation:
    ...
    def addmuala(self,w,rajouts):
       ...
       if "GP" in w["parent"]["features"]: 
           rajouts.append([w["parent"],wmuala,-1])
       else:
...
#traduire.parse("Le Skiffer Electronic Show  allemand sera placé sous le signe de la tablette tactile.",[])
...
#traduire.parse("Le gouvernement de l'Indonésie prévoit de durcir ses règles de contrôle des sites Internet.",[])
