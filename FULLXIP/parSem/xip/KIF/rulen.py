...
def m_mot_0_1(fx,lreturn,tree,nb):
 ...
 # Or
 subtree={}
 if x_test_ord(fx,lret,'A','Z') or x_test_ord(fx,lret,'a','z') or x_test_sup(fx,lret) or x_test_one(fx,lret,'_'):
...
def m_mot_0_2_3(fx,lreturn,tree,nb):
 ...
 # Or
 subtree={}
 if x_test_ord(fx,lret,'A','Z') or x_test_ord(fx,lret,'a','z') or x_test_ord(fx,lret,'0','9')  or x_test_sup(fx,lret) or x_test_one(fx,lret,'_'):
   if x_test_tree(subtree):
     tree['%NODES'].append(subtree)
 else:
   tree.pop('%NODES')
