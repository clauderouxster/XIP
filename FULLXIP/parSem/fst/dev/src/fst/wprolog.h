...
void FstCalcExport networks_to_weighted_prolog_file(NVptr nets, FILE *stream, int sort_states_and_arcs);
void FstCalcExport network_to_weighted_prolog_file(NETptr net, FILE *stream, int sort_states_and_arcs);

NVptr FstCalcExport networks_from_weighted_prolog_file(FILE *stream);

NETptr FstCalcExport wpl_net(char *name);
void FstCalcExport wpl_start(NETptr net, int state_id);
void FstCalcExport wpl_arc(NETptr net, int orig_id, int dest_id, id_type label_id);
void FstCalcExport wpl_final(NETptr net, int state_id);
void FstCalcExport wpl_symbol(NETptr net, int symbol_id);
