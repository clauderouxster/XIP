/* $Id: lab-vect.h,v 1.4 2005/03/04 15:45:24 grondeau Exp $ */
/******************************************************
 **
 **  LAB-VECT.H
 **
...
extern "C" {
 ...
 void FstBaseExport init_lab_vector(void);
 void FstBaseExport free_lab_vector(void);
 id_type FstBaseExport lab_vect_len(void);
 id_type FstBaseExport *lab_vect_labs(void);
 void FstBaseExport add_label(id_type i);
...
extern id_type FstBaseExport *LAB_VECTOR; /* The name is misleading */
extern int FstBaseExport LAB_COUNT_MAX;
...
LAB_VECTORptr FstBaseExport make_lab_vector(int length);
void FstBaseExport reclaim_lab_vector(LAB_VECTORptr lab_vect);
void FstBaseExport assure_lab_vector_space(int len, LAB_VECTORptr lab_vect);
int FstBaseExport append_to_lab_vector(id_type lab, LAB_VECTORptr lab_vect);
int FstBaseExport lab_vector_element_at(id_type *lab, int pos, LAB_VECTORptr lab_vect);
int FstBaseExport set_lab_vector_element_at(id_type lab, int pos, LAB_VECTORptr lab_vect);
void FstBaseExport increment_lab_vector(LAB_VECTORptr lab_vect);
int FstBaseExport decrement_lab_vector(LAB_VECTORptr lab_vect);
int FstBaseExport subtract_from_lab_vector(id_type *lab, LAB_VECTORptr lab_vect);
void FstBaseExport copy_lab_vector(LAB_VECTORptr to, LAB_VECTORptr from);
int FstBaseExport concatenate_lab_vectors(LAB_VECTORptr vect1, LAB_VECTORptr vect2);
int FstBaseExport lab_vector_contains(id_type id, LAB_VECTORptr lab_vector);
int FstBaseExport lab_vector_size(LAB_VECTORptr lab_vect);
void FstBaseExport print_lab_vector(LAB_VECTORptr lab_vect, FILE *stream, int escape_p);
void FstBaseExport reset_lab_vector(LAB_VECTORptr lab_vect);
void FstBaseExport reverse_lab_vector(LAB_VECTORptr lab_vect);
