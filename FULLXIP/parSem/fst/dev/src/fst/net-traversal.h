/* $Id: net-traversal.h,v 1.4 2005/03/04 15:45:24 grondeau Exp $ */
...
void FstBaseExport *start_state_standard(NETptr net, void ** arc_location, int *final);


void FstBaseExport *start_state_compacted(NETptr net, void ** arc_location, int *final);
...
id_type FstBaseExport label_from_arc_location_stand(NETptr net, void ** arc_location, int *final, int *last_arc);

id_type FstBaseExport label_from_arc_location_comp(NETptr net, void ** arc_location, int *final, int *last_arc);
...
void FstBaseExport next_arc_location_stand(NETptr net, void ** arc_location, int last_arc);
        

void FstBaseExport next_arc_location_comp(NETptr net, void ** arc_location, int last_arc);
...
void FstBaseExport *destination_from_arc_stand(NETptr net, void **arc_location);
void FstBaseExport *destination_from_arc_comp(NETptr net, void **arc_location);
