/* $Id: regex-in.h,v 1.4 2005/03/04 15:45:25 grondeau Exp $ */
...
NETptr FstCalcExport net_from_atfile (char *filename, int filetype, int fatstr_p);
...
NETptr FstCalcExport RE2N_net_from_regex_string (char *regex_str);
