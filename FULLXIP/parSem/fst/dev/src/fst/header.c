/* $Id: header.c,v 1.7 2015/11/19 09:24:27 roux Exp $ */
...
void strip_global_headers()
{
	...
	LAST_HEADER.file_length = 0;
	LAST_HEADER.file_type = 0;
	LAST_HEADER.file_version = 0;
	LAST_HEADER.copyright_loc = 0;
	LAST_HEADER.creation_date = 0;
	LAST_HEADER.header_length = 0;
	LAST_HEADER.net_count = 0;
	LAST_HEADER.license_type = 0;
	LAST_HEADER.reserved1 = 0;
	LAST_HEADER.reserved2 = 0;
	LAST_HEADER.reserved3 = 0;
	LAST_HEADER.ascii_date = NULL;
	LAST_HEADER.date_max = 0;
	LAST_HEADER.copyright_notice = NULL;
	LAST_HEADER.copyright_max = 0;
	LAST_HEADER.file_name = NULL;
	LAST_HEADER.file_name_max = 0;
	LAST_HEADER.output_p = 0;
	LAST_HEADER.max_net_count = 0;
	LAST_HEADER.start_locations = NULL;

	NEXT_HEADER.file_length = 0;
	NEXT_HEADER.file_type = 0;
	NEXT_HEADER.file_version = 0;
	NEXT_HEADER.copyright_loc = 0;
	NEXT_HEADER.creation_date = 0;
	NEXT_HEADER.header_length = 0;
	NEXT_HEADER.net_count = 0;
	NEXT_HEADER.license_type = 0;
	NEXT_HEADER.reserved1 = 0;
	NEXT_HEADER.reserved2 = 0;
	NEXT_HEADER.reserved3 = 0;
	NEXT_HEADER.ascii_date = NULL;
	NEXT_HEADER.date_max = 0;
	NEXT_HEADER.copyright_notice = NULL;
	NEXT_HEADER.copyright_max = 0;
	NEXT_HEADER.file_name = NULL;
	NEXT_HEADER.file_name_max = 0;
	NEXT_HEADER.output_p = 0;
	NEXT_HEADER.max_net_count = 0;
	NEXT_HEADER.start_locations = NULL;
