/* $Id: apply.h,v 1.1 2006/06/09 12:53:25 grondeau Exp $ */
...
extern id_type FstBaseExport *INPUT_MATCH;  /* match table of the input side */
extern id_type FstBaseExport *OUTPUT_MATCH; /* match table of the output side */
