...
print("<html>\n<head><title> th&egrave;mes et &eacute;v&eacute;nements factuels </title></head>\n") ;

print("<BODY style=  \"line-height:160%\" BGCOLOR=\"#FFFFFF\" LINK=\"#A62234\">") ;
print("<FONT FACE=\"VERDANA\" SIZE=6><A NAME=\"in\">th&egrave;mes et &eacute;v&eacute;nements factuels</FONT>\n <BR><BR> <FONT FACE=\"VERDANA\" SIZE=4>");
