...
PYTHONHOME=/opt/STools/lib/python2.6
...
/opt/ParSem/bin/linux/xips -grm $GRM1 -tr -f -nodisplay -text $1

java -Xmx256m -cp $JAR1 -jar $JAR2 -grm $GRM2 -text $1 --temp_classif $2 $3 $4 $5 $6 $7 
