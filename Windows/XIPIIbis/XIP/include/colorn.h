...
char m_specials(string& lreturn,x_node** tree);
char m_specials_1(string& lreturn,x_node** tree);
char m_fonction(string& lreturn,x_node** tree);
char m_fonction_2(string& lreturn,x_node** tree);
char m_punct(string& lreturn,x_node** tree);
char m_comments(string& lreturn,x_node** tree);
char m_comments_3(string& lreturn,x_node** tree);
char m_comments_3_4(string& lreturn,x_node** tree);
char m_comments_3_4_5(string& lreturn,x_node** tree);
char m_analyse(string& lreturn,x_node** tree);
char m_analyse_6(string& lreturn,x_node** tree);
char m_analyse_6_7(string& lreturn,x_node** tree);
