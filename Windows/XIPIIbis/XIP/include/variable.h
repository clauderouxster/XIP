...
//---------------------------------------------------------------------------------------
	...
	map<string, string> nomsoriginaux;
//---------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------------
    ...
    */
	...
	vector<hmap<int, hmap<int, int> > > distances;
	vector<hmap<int, hmap<int, int> > > distancesarbre;
	...
	char litbrut(istream& fichier, char *tampon);
