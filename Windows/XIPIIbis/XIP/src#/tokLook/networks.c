/* $Id: networks.c,v 1.93 2003/04/28 14:36:51 privault Exp $ */
...
static char rcs_id_lookup[] = "$Id: networks.c,v 1.93 2003/04/28 14:36:51 privault Exp $";
/* --- Debug help ----------------------------------------------------*/
...
#endif
			sprintf(buffer_erreur,"network file '%s' could not be found or opened", line);
