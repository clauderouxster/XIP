...
typedef enum {
	...
	kifLong, kifShort, kifFraction, kifLock, kifNamedLoquet, kifPrint, kifPString, kifPInteger, kifPFloat, kifInfinitiveVector, kifCycleVector, kifReplicateVector,
...
double wconvertfloat(wstring value);
long wconvertinteger(wstring value);
...
public:
	...
	hmap<short, KifTable*> triggertable;
	...
	hmap<short, KifElement*> basevalues;
...
public:
	...
	virtual Exported KifElement* orset(KifElement* a, KifElement* b, KifElement*  bool autoself) {
		if (a == this)
			return kifNULL;
		return a->orset(a, b,  autoself);
	}
	virtual Exported KifElement* xorset(KifElement* a, KifElement* b, KifElement*  bool autoself) {
		if (a == this)
			return kifNULL;
		return a->xorset(a, b,  autoself);
	}
	virtual Exported KifElement* andset(KifElement* a, KifElement* b, KifElement*  bool autoself) {
		if (a == this)
			return kifNULL;
	...
	virtual Exported KifElement* minus(KifElement* a, KifElement* b, KifElement*  bool autoself) {
		if (a == this)
			return kifNULL;
		return a->minus(a, b,  autoself);
	}
	virtual Exported KifElement* multiply(KifElement* a, KifElement* b, KifElement*  bool autoself) {
		if (a == this)
			return kifNULL;
		return a->multiply(a, b,  autoself);
	}
	virtual Exported KifElement* divide(KifElement* a, KifElement* b, KifElement*  bool autoself) {
		if (a == this)
			return kifNULL;
		return a->divide(a, b,  autoself);
	}
	virtual Exported KifElement* mod(KifElement* a, KifElement* b, KifElement*  bool autoself) {
		if (a == this)
			return kifNULL;
		return a->mod(a, b,  autoself);
	}
	virtual Exported KifElement* shiftright(KifElement* a, KifElement* b, KifElement*  bool autoself) {
		if (a == this)
			return kifNULL;
		return a->shiftright(a, b,  autoself);
	}
	virtual Exported KifElement* shiftleft(KifElement* a, KifElement* b, KifElement*  bool autoself) {
		if (a == this)
			return kifNULL;
		return a->shiftleft(a, b,  autoself);
	}
	virtual Exported KifElement* power(KifElement* a, KifElement* b, KifElement*  bool autoself) {
		if (a == this)
			return kifNULL;
...
public:
	...
	Exported virtual KifElement* plus(KifElement* a, KifElement* b,  bool autoself);
	Exported virtual KifElement* minus(KifElement* a, KifElement* b,  bool autoself);
	Exported virtual KifElement* multiply(KifElement* a, KifElement* b,  bool autoself);
	Exported virtual KifElement* divide(KifElement* a, KifElement* b,  bool autoself);
	Exported virtual KifElement* mod(KifElement* a, KifElement* b,  bool autoself);
	Exported virtual KifElement* shiftright(KifElement* a, KifElement* b,  bool autoself);
	Exported virtual KifElement* shiftleft(KifElement* a, KifElement* b,  bool autoself);
	Exported virtual KifElement* power(KifElement* a, KifElement* b,  bool autoself);
	Exported virtual KifElement* xorset(KifElement* a, KifElement* b,  bool autoself);
	Exported virtual KifElement* orset(KifElement* a, KifElement* b,  bool autoself);
	Exported virtual KifElement* andset(KifElement* a, KifElement* b,  bool autoself);
...
public:
	...
	Exported KifElement* orset(KifElement* a, KifElement* b, KifElement*  bool autoself) {
		if (autoself) {
			value |= b->Integer();
			return this;
		}
...
public:
	...
	Exported KifElement* multiply(KifElement* a, KifElement* b, KifElement*  bool autoself) {
		if (autoself) {
			value *= b->Byte();
			return this;
		}
...
public:
	...
	Exported KifElement* Copy(KifDomain* kp, KifElement* dom = kifNULL) {
		...
		if (value != NULL) {
			v->value = new unsigned char[size];
			v->size = size;
	...
	wstring UString() {
		if (value == NULL)
			return L"";
		wstring res;
		s_utf8tounicode(res, (char*)value);
		return res;
	}
...
public:
	...
	KifFileWide(KifCode* klc, KifElement* kp) : localstring(new KifUString(NULL, NULL, 0)), thefile(NULL), KifBaseFile(klc, kp, kifFileWide) {
		localstring->kifcode = kifcode;
	}
...
public:
	...
	Exported KifElement* Exec(KifElement* contextualpattern, KifDomain* dom, KifElement* val, int idthread, KifCallFunction*) { return this; }
...
inline void ujstringing(std::wstringstream& res, wstring& value) {
	if (value.find(L"\"") == -1)
		...
		wstring v = c_replacewstring(value, L"\"", L"\\\"");
		res << L"'" << v << L"'";
	}
}
