...
public:
	...
	KifVectorNumberPtr(KifCode* klc,KifElement* kp,VECTA<double>* v) : KifElement(klc,kp,kifVectorPtr) {
		values=v;
		it=0;
	}
	bool Variable() {
...
public:
	...
	bool Setvalue(KifElement* a,KifElement* index=NULL,KifElement* dom=NULL,int idthread=0,KifCallFunction* callfunc=NULL);
	...
	KifElement* Execute(KifElement* pattern,KifDomain* dom,KifElement* val);
	KifElement* in(KifElement* a,KifElement* b,KifDomain* kfunc,KifElement* pattern,bool idx);
...
public:
	...
	KifElement* Execute(KifElement* pattern,KifDomain* dom,KifElement* val=kifNULL);
...
public:
	...
	virtual bool Setvalue(KifElement* a,KifElement* index=NULL,KifElement* dom=NULL,int idthread=0,KifCallFunction* callfunc=NULL);
	KifElement* Execute(KifElement* pattern,KifDomain* dom,KifElement* val=kifNULL);
...
public:
	...
	KifElement* multiply(KifElement* a, KifElement* b, KifElement* context, int idthread,KifCallFunction * callfunc,bool autoself); //In this case, it will be used for composition
