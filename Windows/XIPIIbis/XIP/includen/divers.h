...
inline unsigned char* dupch(unsigned char* mot) {
    return (unsigned char*)strdup((char*)mot);
}

//compare deux chaines de caracteres sans tenir compte de la casse
inline char copiech(unsigned char* mot1, unsigned char* mot2) {
    strcpy((char*)mot1,(char*)mot2);    
    return 0;
}

//compare deux chaines de caracteres sans tenir compte de la casse
inline char concatch(unsigned char* mot1, unsigned char* mot2) {
    strcat((char*)mot1,(char*)mot2);    
    return 0;
}
