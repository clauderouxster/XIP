...
class KifTreeMapString : public KifEvaluateMapValue {
public:
	...
	KifTreeMapString(KifCode* klc,KifElement* kp) : KifEvaluateMapValue(klc,kp,kifTreeMapString) {}
...
class KifIteratorTreeMapString : public KifIterationContainer {
public:
	...
	KifIteratorTreeMapString(KifCode* klc,KifElement* kp,KifTreeMapString* k) : KifIterationContainer(klc,kp,k) {}
...
class KifTreeMapInteger : public KifEvaluateMapValue {
public:
	...
	KifTreeMapInteger(KifCode* klc,KifElement* kp) : KifEvaluateMapValue(klc,kp,kifTreeMapInteger) {}
...
class KifIteratorTreeMapInteger : public KifIterationContainer {
public:
	...
	KifIteratorTreeMapInteger(KifCode* klc,KifElement* kp,KifTreeMapInteger* k) : KifIterationContainer(klc,kp,k) {}
...
class KifTreeMapFloat : public KifEvaluateMapValue {
public:
	...
	KifTreeMapFloat(KifCode* klc,KifElement* kp) : KifEvaluateMapValue(klc,kp,kifTreeMapFloat) {}
...
class KifIteratorTreeMapFloat : public KifIterationContainer {
public:
	...
	KifIteratorTreeMapFloat(KifCode* klc,KifElement* kp,KifTreeMapFloat* k) : KifIterationContainer(klc,kp,k) {}
