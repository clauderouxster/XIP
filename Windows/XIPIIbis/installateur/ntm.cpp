...
BEGIN_MESSAGE_MAP(Cntm, CDialog)
	...
	ON_BN_CLICKED(IDC_ntmtowindows, Onntmtowindows)
	ON_BN_CLICKED(IDC_ntmtounix, Onntmtounix)
...
void Cntm::Onntmtowindows() 
{
	// TODO: Add your control notification handler code here
    UpdateData(TRUE);
    vector<CString> vect;	
    int i;
    for (i=0;i<m_chemins.GetCount();i++) {
        CString v;
