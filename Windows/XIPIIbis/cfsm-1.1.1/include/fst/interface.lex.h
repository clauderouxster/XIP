...
/* $Id: interface.lex.h,v 1.9 2002/05/07 13:05:07 jmcoursi Exp $ */
...
void print_a_prompt(char *);

FsmFstExport void interface_lex_total_restart();
FsmFstExport finfo *interface_file_info;
...
int FsmFstExport wait_for_confirm2(void);
...
FsmFstExport void start_flex(FILE *);
