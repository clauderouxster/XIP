...
/* $Id: interface.h,v 1.31 2002/11/27 09:05:07 privault Exp $ */
...
FsmFstExport extern struct STRIntPar
{
...
void yacc_restart(void);
FsmFstExport void execute_commands(FST_CNTXT *);
FsmFstExport void execute_string(char *, FST_CNTXT *);
FsmFstExport void iy_source(ifile *, FST_CNTXT * );

extern char *interface_text;
extern int interface_leng;
extern int user_license_type;
