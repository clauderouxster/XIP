/* $Id: label.h,v 1.28 2003/01/10 08:29:51 jmcoursi Exp $ */
...
extern FsmFstExport LABEL_ID_MAPptr LABEL_MAP;
...
int FsmFstExport atomic_label_to_id(id_type *id, FAT_STR name);
int symbol_to_id(id_type *id, FAT_STR name, LABEL_ID_MAPptr symbol_table);
int FsmFstExport make_pair_label(id_type *id_tuple, id_type upper_id, id_type lower_id);
int FsmFstExport make_fstlabel(id_type *tuple_id, id_type upper_id, id_type lower_id);
int intern_symbol_name(id_type *id, FAT_STR name, LABEL_ID_MAPptr symbol_table);
int FsmFstExport intern_atomic_label(id_type *id, FAT_STR name);
int intern_tuple_label(id_type *tuple_id, id_type *labels, int16 arity);
int FsmFstExport intern_literal(id_type *id, char *name);
int FsmFstExport utf8_intern_literal(id_type *id, char *name);
int FsmFstExport intern_unicode(id_type *id, char *name);
int FsmFstExport utf8_intern_unicode(id_type *id, char *name);
int FsmFstExport intern_unicode_symbol(id_type *id, FAT_STR name);
int FsmFstExport intern_symbol(id_type *id, char *name);
void FsmFstExport intern_char(id_type *new_id, char c);
...
extern id_type FsmFstExport EPSILON;
extern id_type FsmFstExport OTHER;
extern id_type FsmFstExport DUMMY_LABEL;
extern id_type FsmFstExport BOUNDARY_SYMBOL;
extern id_type FsmFstExport ALTCHAIN_SYMBOL;
extern id_type FsmFstExport SPACE_SYMBOL;
extern id_type FsmFstExport REPEAT_SYMBOL;
extern id_type DET_EPSILON;
...
int FsmFstExport name_to_atom_id(id_type *id, FAT_STR name);

int FsmFstExport print_label(id_type id, FILE *stream, int escape_p);
int FsmFstExport fat_to_thin_name(char *buffer, FAT_STR name, int max, int escape_p);
int FsmFstExport utf8_fat_to_thin_name(char *buffer, FAT_STR name, int max, int escape_p);

int copy_label_name(id_type id, int side, char *buffer, int max, int eps_to_zero_p, int escape_p);
int FsmFstExport utf8_copy_label_name(id_type id, int side, char *buffer, int max, int eps_to_zero_p, int escape_p);
void FsmFstExport print_global_labels(FILE *stream);

id_type FsmFstExport upper_id(id_type id);
id_type FsmFstExport lower_id(id_type id);

void FsmFstExport clear_label_data(void);
