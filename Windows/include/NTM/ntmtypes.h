...
*****************************/
#define NTM_INPUTALPHABET_SIZE 256 /* size of the input alphabet, 256 for Ascii */
...
#define MORPHO_CONFIGS_MAXNB 5001
#define MORPHO_CCONFIGS_MAXNB 10001
#define MORPHO_TEMPOSOL_MAXSIZE 5000
...
#define IS_NORMALCHAR(id) ( id <= inputIdVect[NTM_INPUTALPHABET_SIZE-1] )
...
typedef struct {
    ...
    int isFinal; /* initially set to 0 */
...
/* Global Variables
********************/
extern id_type inputIdVect[NTM_INPUTALPHABET_SIZE];
