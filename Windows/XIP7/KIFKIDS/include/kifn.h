...
char m_pasdans(string& lreturn,x_node** tree);
char m_pasdans_0_1(string& lreturn,x_node** tree);
char m_pasdans_0_2(string& lreturn,x_node** tree);
char m_pasdans_0_3(string& lreturn,x_node** tree);
char m_pasdans_0_4(string& lreturn,x_node** tree);
char m_dans(string& lreturn,x_node** tree);
char m_sur(string& lreturn,x_node** tree);
...
char m_loop_0_1(string& lreturn,x_node** tree);
char m_loop_0_1_2(string& lreturn,x_node** tree);
char m_doloop(string& lreturn,x_node** tree);
char m_for(string& lreturn,x_node** tree);
char m_for_0_1(string& lreturn,x_node** tree);
char m_for_0_2(string& lreturn,x_node** tree);
char m_for_0_5(string& lreturn,x_node** tree);
