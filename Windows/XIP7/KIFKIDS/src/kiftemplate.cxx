...
static void MethodInitialization(KifCode* kifcode,string name,TemplateNameMethod func,int arity,string infos) {
...
extern "C" {
	Exported bool Init_TemplateName(KifCode* kifcode,string version) {
		...
		TemplateName_type=KifAddNewType("TemplateName",CreatekifTemplateNameElement);
	...
	Exported bool TemplateName_KifInitialisationModule(KifCode* kifcode,string version) {
		...
		MethodInitialization(kifcode,"sample",&KifTemplateName::MethodSample,P_TWO,"sample(x,y): example of a method implementation");
