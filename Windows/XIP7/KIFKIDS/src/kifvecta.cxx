...
bool KifVecta::Setvalue(KifElement* ke,KifElement* idx,KifElement* dom) {
#ifdef PROFILING
...
KifElement* KifVecta::plus(KifElement* a,KifElement* b,bool autoself) {
#ifdef PROFILING
...
KifElement* KifVecta::minus(KifElement* a,KifElement* b,bool autoself) {
#ifdef PROFILING
...
KifElement* KifVecta::multiply(KifElement* a,KifElement* b,bool autoself) {
#ifdef PROFILING
...
KifElement* KifVecta::divide(KifElement* a,KifElement* b,bool autoself) {
#ifdef PROFILING
...
KifElement* KifVecta::mod(KifElement* a,KifElement* b,bool autoself) {
#ifdef PROFILING
...
KifElement* KifVecta::shiftright(KifElement* a,KifElement* b,bool autoself) {
#ifdef PROFILING
...
KifElement* KifVecta::shiftleft(KifElement* a,KifElement* b,bool autoself) {
#ifdef PROFILING
...
KifElement* KifVecta::power(KifElement* a,KifElement* b,bool autoself) {
#ifdef PROFILING
