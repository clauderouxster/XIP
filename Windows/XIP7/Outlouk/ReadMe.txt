========================================================================
    ACTIVE TEMPLATE LIBRARY : Outlouk Project Overview
========================================================================

AppWizard has created this Outlouk project for you to use as the starting point for
...
Outlouk.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Outlouk.h)
        GUID definitions                                (Outlouk_i.c)
        A type library                                  (Outlouk.tlb)
        Marshaling code                                 (Outlouk_p.c and dlldata.c)

Outlouk.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Outlouk.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named Outlouk.pch and a precompiled types file named StdAfx.obj.
...
Outloukps.vcxproj
	...
	dlldata.c, Outlouk_i.c and Outlouk_p.c which are required
	to build the proxy/stub DLL.

Outloukps.vcxproj.filters
