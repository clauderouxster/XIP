...
/* at Thu Nov 20 10:44:57 2014
 */
/* Compiler settings for Outlouk.idl:
...
typedef struct _Outlouk_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } Outlouk_MIDL_TYPE_FORMAT_STRING;

typedef struct _Outlouk_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } Outlouk_MIDL_PROC_FORMAT_STRING;

typedef struct _Outlouk_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } Outlouk_MIDL_EXPR_FORMAT_STRING;
...
extern const Outlouk_MIDL_TYPE_FORMAT_STRING Outlouk__MIDL_TypeFormatString;
extern const Outlouk_MIDL_PROC_FORMAT_STRING Outlouk__MIDL_ProcFormatString;
extern const Outlouk_MIDL_EXPR_FORMAT_STRING Outlouk__MIDL_ExprFormatString;
...
static const Outlouk_MIDL_PROC_FORMAT_STRING Outlouk__MIDL_ProcFormatString =
    {
        0,
        {
...
static const Outlouk_MIDL_TYPE_FORMAT_STRING Outlouk__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    Outlouk__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    Outlouk__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _Outlouk_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _Outlouk_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
};

PCInterfaceName const _Outlouk_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
    0
};

const IID *  const _Outlouk_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _Outlouk_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _Outlouk, pIID, n)

int __stdcall _Outlouk_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_Outlouk_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo Outlouk_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _Outlouk_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Outlouk_StubVtblList,
    (const PCInterfaceName * ) & _Outlouk_InterfaceNamesList,
    (const IID ** ) & _Outlouk_BaseIIDList,
    & _Outlouk_IID_Lookup, 
    1,
    2,
