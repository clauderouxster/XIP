...
SOAP_SOURCE_STAMP("@(#) soapServer.cpp ver 2.8.22 2015-07-27 11:44:55 GMT")
...
extern "C" SOAP_FMAC5 int SOAP_FMAC6 soap_serve_request(struct soap *soap)
{
	...
	if (!soap_match_tag(soap, soap->tag, "ns1:call"))
		return soap_serve___kifrest__call(soap);
	return soap->error = SOAP_NO_METHOD;
}
#endif

SOAP_FMAC5 int SOAP_FMAC6 soap_serve___kifrest__call(struct soap *soap)
{	struct __kifrest__call soap_tmp___kifrest__call;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __kifrest__call(soap, soap_tmp___kifrest__call.ns1__call, soap_tmp___kifrest__callResponse.ns1__callResponse);
	if (soap->error)
		return soap->error;
