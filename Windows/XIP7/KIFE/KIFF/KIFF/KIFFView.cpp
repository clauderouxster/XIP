...
BEGIN_MESSAGE_MAP(CKIFFView, CRichEditView)
	...
	ON_COMMAND(ID_WXIP_NOBREAK, &CKIFFView::OnWxipNobreak)
	ON_UPDATE_COMMAND_UI(ID_WXIP_NOBREAK, &CKIFFView::OnUpdateWxipNobreak)
	...
	ON_COMMAND(ID_FORMAT_FONT, &CKIFFView::OnFormatFont)
END_MESSAGE_MAP()
