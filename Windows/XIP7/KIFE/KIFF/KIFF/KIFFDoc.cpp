...
// KIFFDoc.cpp : implémentation de la classe CKIFFDoc
//
...
void CKIFFDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())	{
		...
		//short par short...
		//wstring cs;
		//s_doubleutf8tounicode(cs,(wchar_t*)LPCTSTR(contenu),contenu.GetLength());
		//c_replacewstring(cs,L"\r\n",L"\n");
		//c_replacewstring(cs,L"\r",L"\n");
		//contenu=cs.c_str();
	}
}
