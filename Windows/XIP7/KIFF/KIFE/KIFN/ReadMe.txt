...
L'Assistant Application a créé cette application KIFN pour 
...
KIFNView.h, KIFNView.cpp - la vue du document
    ...
    Les objets CKIFNView servent à afficher les objets 
    CKIFNDoc.

res\KIFNDoc.ico
    Il s'agit d'un fichier icône, qui est utilisé comme icône des fenêtres 
    enfants MDI pour la classe CKIFNDoc.  Cette icône est incluse 
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé KIFN.pch et un fichier de type précompilé 
    nommé Stdafx.obj.
