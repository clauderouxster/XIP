...
public class TestUtilities {
     ...
     * of the URL.
     * 
     * In order to use a URL, we need to first check if it's valid. 
     * This method Help to find the valid URL and return the String form of it back. 
     * 
     * @param path
     * @param filename
    ...
    /**
     * Find the names of the named graphs with the following information
     * Sample SPARQL query to retrieve data using information from different named graphs
     */
    public static ResultSet selectNamedGraphs(JenaKBManager kbm,String property, String entityName, String entityType){
        String restriction =                            
                            "{GRAPH ?g" +
                            "{?name   ns:state  ?x4. \r\n}" +
                            "?name ns1:hasMention ?mention. \r\n" +
                            "?mention ns1:hasForm \"Nobel\".\r\n" +
                            "{GRAPH ?x4" +
                            "{?subject ?x2 ?object. \r\n}}"+ 
                            "?subject ns1:hasMention ?mention1 .\r\n"+
                            //"?mention1 ns1:hasUrl ?x3.\r\n" +
                            "?mention1 ns1:hasForm ?x1.\r\n" +
                            //"?object rdf:type   ns:"+entityName+".\r\n"+
                            "?object ns1:hasMention ?mention2.\r\n" +
                            "?mention2 ns1:hasForm ?x3}";

        log.info("\n\nAsked graphs");
        ResultSet rs = kbm.queryXItem(restriction,4);
        String title = "Occurrences of the selected graphs";
    ...
    /**
     * Find the information involved in the identified graphs
     * 
     * 
     * @param kbm
     * @param entityName
     ...
     */
    public static ResultSet TestNamedGraphsWithReasoner(JenaKBManager kbm, String entityName, String property, String entityType)
    {
        String restriction =
                //"{?x1 ?x2 ?x3}";
                           "?entity               rdf:type           ns:"+entityType+"        .\r\n"
                           + "?entity               ns:"+property+"    ?property                .\r\n"
                           + "?entity               ns1:hasMention     ?mention2                .\r\n"
                           + "?mention2             ns1:hasForm        ?x2                      .\r\n"
                           //+ "?property             rdf:type           ?x2                 .\r\n"
                           + "?property             ns1:hasMention     ?mention                 .\r\n"
                           //+ "?mention              ns1:hasForm        \""+entityName+"\"       .\r\n"
                           + "?mention              ns1:hasForm        ?x1.                      ";
        
        log.info("\n\nAsked Entity ("+entityType+")");
        System.out.println("Finished creating model"+System.currentTimeMillis());
        ResultSet rs = kbm.queryXItem(restriction,2);
        System.out.println("Finished creating model"+System.currentTimeMillis());
        String title = "Occurrences of the Names ("+entityType+")";
        JenaKBManager.displayResultSet(rs,title);
        return rs;
    }
    
    /**
     * Find the URI of the named graphs with the following information
     * 
     * @param contextParameter
     */
    public static void selectNamedGraphs(JenaKBManager kbm, String contextParameter){
        String restriction;
        if (contextParameter.equals("")){
            restriction = "{GRAPH ?x1 {?s ?p ?o}}";
        }
        else {
            restriction = "{GRAPH ?g" +
                          "{?name   ns:state  ?x1. \r\n}"+
                          "?name ns1:hasMention ?mention. \r\n" +
                          "?mention ns1:hasForm \""+contextParameter+"\".\r\n}";            
        }
        log.info("\n\nAsked graphs");
        kbm.queryContextItem(restriction);        
    }
    ...
    public static ResultSet getOccurrences(JenaKBManager kbm, String entityName, String entityType)
    {
     ...
     /**
     * Find out all occurrences using the LUBM atificially generated corpus
     * 
     * 
     * @param kbm
     * @param entityName
     ...
     * @return the ResultSet rs 
     */
    public static ResultSet getOccurrences(JenaKBManager kbm, String property, String entityName, String entityType)
    {
        String restriction = "?x1               rdf:type           ub:"+entityType+"        .\r\n"
                           + "?x1               ub:"+property+"        <"+entityName+">                  .\r\n";
                          /* //+ "?entity           rdf:type          ns:Person               .\r\n"
                           + "?x2               ns1:hasMention     ?mention                 .\r\n"
                           + "?mention          ns1:hasForm        \""+entityName+"\"       .\r\n";*/
    ...
    /**
     * Find out all graph names where the RDF triple can be found.
     * 
     * 
     * @param kbm
     * @param entityName
     ...
     * @return the ResultSet rs 
     */
    public static ResultSet getNames(JenaKBManager kbm, String property, String entityName, String entityType)
    {
        String restriction = "GRAPH ?x1      {\r\n" 
                           + "?entity               rdf:type           ns:"+entityType+"        .\r\n"
                           + "?entity               ns:"+property+"    ?property                      .\r\n"
                           //+ "?property             rdf:type           ns:Person               .\r\n"
                           + "?entity             ns1:hasMention     ?mention2                 .\r\n"
                           + "?mention2              ns1:hasForm        ?x2                   .\r\n"
                           + "?property             ns1:hasMention     ?mention                .\r\n"
                           + "?mention              ns1:hasForm        \""+entityName+"\"                   .\r\n"
                           + "?mention              ns1:hasForm        ?x3                   .}\r\n";
    ...
    public static ResultSet getEntityTypeOccurrences(JenaKBManager kbm, String entityType)
    {
        ...
        ResultSet rs = kbm.queryXItem(restriction,1);
