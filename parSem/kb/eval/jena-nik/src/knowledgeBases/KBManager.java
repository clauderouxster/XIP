...
//    // database URL
//    public final static String M_DB_URL = "jdbc:mysql://etretat:3306/sdbNamedGraphs";
//    // User name
...
//    public final static DatabaseType M_DB_TYPE = DatabaseType.MySQL;

    // database URL
    public final static String M_DB_URL = "jdbc:derby:derbydb-sdbNamedGraphs";
    // User name
    public final static String M_DB_USER = "";
    // Password
    public final static String M_DB_PASSWD = "";
    // JDBC driver
    public final static String M_DBDRIVER_CLASS = "org.apache.derby.jdbc.EmbeddedDriver";
    public final static DatabaseType M_DB_TYPE = DatabaseType.Derby;
