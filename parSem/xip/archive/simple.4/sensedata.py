...
senses["deer"] = [{"wordata":"deer$ reieg reiag","francais":["à"],"english":["to"]}]
...
senses["kontentedjeiag"] = [{"wordata":"retan kontentedjeiag#1","francais":["verb(#1),prep(de)"]}]

senses["drinkedeiag"] = [{"wordata":"likvejetan#2 drinkedeiag#1", "francais":["verb(#1),prep(de),noun(#2)"]}]
senses["drinkeiag"] = [{"wordata":"likvejetan#2 drinkeiag#1", "francais":["verb(#1),prep(avec),prep(de),noun(#2)"]}]
