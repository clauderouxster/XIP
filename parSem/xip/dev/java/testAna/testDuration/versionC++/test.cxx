...
int main(int argc, char *argv[]) {
    try {
        int gHandler = loadGrammar("..\\..\\..\\..\\GRAMMARS\\ENGLISH\\GRMFILES\\GRAM_GEN\\gram_gen_entit.grm");
        //int gHandler = loadGrammar("../../../../GRAMMARS/ENGLISH/GRMFILES/GRAM_GEN/gram_gen_entit.grm");
        parse(gHandler, "../input-1000");
        parse(gHandler, "../input-5000");
        parse(gHandler, "../input-10000");
        parse(gHandler, "../input-20000");
        parse(gHandler, "../input-30000");
        parse(gHandler, "../input-50000");
        parse(gHandler, "../input-100000");
