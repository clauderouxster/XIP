/* $Id: tok-aux.c,v 1.12 2015/11/20 15:07:44 roux Exp $ */
...
static char rcs_id[] = "$Id: tok-aux.c,v 1.12 2015/11/20 15:07:44 roux Exp $";
...
int deterministic_tokenize(NETptr token_fst,
	...
	*/
	...
	if (*a_parse_table == NULL)
		*a_parse_table = get_parse_table(token_fst, LOWER);

	parse_table = *a_parse_table;
