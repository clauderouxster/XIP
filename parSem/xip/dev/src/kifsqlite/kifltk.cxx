...
extern "C" {
	...
	Exporting bool kifltk_KifInitialisationModule(KifCode* kifcode, string version) {
		...
		MethodInitializationWindow("transformedvertex", &Kifcomplexwidget::MethodTransform_x, P_TWO, "transformedvertex(float x, float y): add transformations to vertices list.");
