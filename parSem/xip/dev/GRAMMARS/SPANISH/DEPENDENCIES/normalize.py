...
#        newword = "not"
    ...
    # Workaround for a XIP bug: command-line XIP passes Latin-1, but
    # libxip.so called from python passes UTF-8.  Try decoding UTF-8
    # first because it usually fails on an Latin-1 string, although
    # there may be cases where this heuristic fails (I don't know).
    # Get rid of this when the XIP bug is fixed.
    try:
        newword = newword.decode('utf-8')
    except UnicodeDecodeError:
        newword = newword.decode('iso-8859-1')
