...
#Creator: Malvina Nissim
#######################

#####################################################
#Purpose: remove BNC entities and replace them with standard characters as far as possible
# Example call: perl remove-characters.pl companies.train
#Example Call: perl remove-characters.pl companies.train.BNCtagged
######################################################
...
BEGIN {
    ...
    %entity = (
       ...
       lt     => '<',     #a less-than # commentend out for claire's procedure
        gt     => '>',     #a greater-than
       amp    => '&',     #a nampersand # # commentend out for claire's procedure
       bquo   => '"', 
        equo   => '"', 
