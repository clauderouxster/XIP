...
parser p('H:\GRAMMARS\ENGLISH\APPLICATIONS\SCOOP\GRMFILES\scoop-restaurant.grm');
...
inputXml.save('W:\users\Roux\xip\parSem\xip\dev\GRAMMARS\ENGLISH\APPLICATIONS\SCOOP\scripts_SemEval\svm\Restaurants_Train_XRCEresultV1.xml');
inputXml.close();
