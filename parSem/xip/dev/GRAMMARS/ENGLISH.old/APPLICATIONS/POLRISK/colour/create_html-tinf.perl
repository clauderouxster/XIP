...
print("<html>\n<head><title> &eacute;v&eacute;nements factuels </title></head>\n") ;

print("<BODY style=  \"line-height:160%\" BGCOLOR=\"#FFFFFF\" LINK=\"#A62234\">") ;
print("<FONT FACE=\"VERDANA\" SIZE=6><A NAME=\"in\">L'information apport&eacute;e par le texte : les &eacute;v&eacute;nements qui se sont produits</FONT>\n <BR><BR> <FONT FACE=\"VERDANA\" SIZE=4>");
