...
#ifdef XIPLIBXML
    virtual void CreationXMLNoeud(GlobalParseur*,xmlNodePtr,Noeud*) {}
    virtual void CreationXML(GlobalParseur*,xmlNodePtr) {}
	virtual void CreationXMLDependance(GlobalParseur*,xmlNodePtr,ResultatFonction*) {}
    virtual Variable* clone() { return NULL; }
#endif
};

#ifdef XIPLIBXML
class VariableXML : public Variable {
public:
    xmlNodePtr noeud;
    VariableXML(char* n, typeVariable ty,sorteVariable l,xmlNodePtr nd) : Variable(n,ty,l,NON) {
        noeud=nd;
    }
    ~VariableXML();
};
...
#ifdef XIPLIBXML
    void CreationXMLNoeud(GlobalParseur*,xmlNodePtr,Noeud*);
    void CreationXML(GlobalParseur*,xmlNodePtr);
#endif
...
#ifdef XIPLIBXML
	void CreationXMLNoeud(GlobalParseur*,xmlNodePtr,Noeud*) {}
	void CreationXML(GlobalParseur* parseur,xmlNodePtr parent);
#endif
...
#ifdef XIPLIBXML
    virtual void CreationXMLNoeud(GlobalParseur*,xmlNodePtr parent,Noeud* n);
#endif
...
#ifdef XIPLIBXML
    void CreationXMLDependance(GlobalParseur*,xmlNodePtr,ResultatFonction*);
#endif
};
...
#ifdef XIPLIBXML
class TestFormuleElementXML : public TestFormuleElement {
public:
    VariableXML* vxml;
    TestFormuleElementXML(VariableXML* v) {
        type=VXMLOBJET;
        vxml=v;
    }
};
...
#ifdef XIPLIBXML
class TestFonctionXML : public TestFonction {
public:
    ...
    ~TestFonctionXML();
    typeTESTFONCTION Type() {return TESTFONCTIONXML;}    
    char execute(ContexteInference& ci,int i,ListeTestArbre* lt,Signature& cumule,
        VECTA<Traits*>& vecttr,VECTA<Traits*>& affectation,char& res);
};
