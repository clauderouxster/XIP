...
create table concepttosentences (idconcept INT not NULL, rank SMALLINT UNSIGNED not NULL, value SMALLINT UNSIGNED not NULL, INDEX concept (idconcept,rank));
create table dependances (idsource INT not NULL, idsent INT not NULL, iddep INT not NULL, rank SMALLINT UNSIGNED not NULL,value SMALLINT UNSIGNED not NULL,type CHAR(1) not NULL,INDEX sentences (idsent,iddep,rank), INDEX fichier (idsource,idsent,iddep,rank) );
create table sentencetoconcepts ( idsent INT not NULL, rank SMALLINT UNSIGNED not NULL,value SMALLINT UNSIGNED not NULL, INDEX sentences(idsent,rank));
