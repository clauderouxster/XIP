/* $Id: debug.h,v 1.4 2005/03/04 15:45:22 grondeau Exp $ */
/**************************************
 *
 *  DEBUG.H
 *
...
void FstBaseExport debug_print_arc(ARCptr narc, int arc_number);
void debug_print_state(STATEptr nstate, int state_number, int with_arcs);
void FstBaseExport debug_print_net(NETptr net, int with_arcs);
