/* $Id: subseq.c,v 1.5 2015/11/19 09:24:27 roux Exp $ */
...
#ifdef __GNUC__
static char rcs_id_subseq[] __attribute__ ((unused)) = "$Id: subseq.c,v 1.5 2015/11/19 09:24:27 roux Exp $";
#endif
